...
# HEADER
# -----------------------------------------------------------
st.markdown("<div class='section-title'>🌿 AirGuard™ — Project Overview</div>", unsafe_allow_html=True)
...
AirGuard™ is an AI-driven pollution monitoring dashboard designed to help users understand real-time and predicted Air Quality Index (AQI).  
...
People often *cannot understand AQI values, **cannot predict future pollution, and **lack real-time insights*.  
...
st.markdown("<div class='footer'>AirGuard™ — Built with ❤ by Team NexGen Yodhas</div>", unsafe_allow_html=True)